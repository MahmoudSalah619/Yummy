...
export default function MessageDetailsOrganism() {
  return (
    <div className={styles.container}>
      ...
      />
      <MessageContainer
        message="Hi,I recently placed an order with your store (Order #12345) on December 18th, and it was supposed to be delivered by December 22nd. However, I haven’t received the package yet, and the tracking information hasn’t been updated since December 20th.
